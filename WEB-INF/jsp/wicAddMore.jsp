...
<s:form action="wicAdd" method="post">    
  ...
  <table border="1" width="90%">
		<tr><td> 
			<table width="100%" border="1"><caption>Transaction ID:<s:property value="%{wic.id}" /></caption>
				<tr>
					<td align="right"><label>Amount:</label></td>
					<td align="right">$<s:property value="%{wic.amount}" />.00</td>
				</tr>
				<tr>
				...
				<s:elseif test="wic.hasBalance()">
					<tr bgcolor="red">
						...
						<td align="right">$<s:property value="%{wic.balance}" />.00</td>
					</tr>
				</s:elseif>
			</table>
		</td></tr>
