  ...
  <table border="1" width="80%">
	  ...
	  <td>
		  ...
		  <tr>
		      ...
		      <td align="left"><label> From</label><s:textfield name="redeemList.date_from" value="%{redeemList.date_from}" size="10" maxlength="10" cssClass="date" /><label> To </label><s:textfield name="redeemList.date_to" value="%{redeemList.date_to}" size="10" maxlength="10" cssClass="date" /></td>
		  </tr>  
		  <tr>
