...
<s:if test="buck.hasEbt()">
	...
	<table border="1"><caption>Related Ebt</caption>
		...
		<tr>
			<td><a href="<s:property value='#application.url' />issueAdd.action?id=<s:property value='buck.ebt.id' />">View Ebt </a></td>
